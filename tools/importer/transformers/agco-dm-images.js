 ...
 * Source contains Scene7 IS/Image URLs (s7d9.scene7.com/is/image/...).
 * Rewrites DM <img> tags into anchors that survive the docx→markdown
 * round-trip; the companion auto-block in scripts/scripts.js rebuilds
 * responsive <picture> markup at render time.
 * Runs in afterTransform only (block parsers extract <img> into block cells
 * between the hooks). See references/dm-scene7-transformer.md.
 */
